...
public class AlterarActivity extends AppCompatActivity {
    ...
    public void alterar(){
        ...
        finish(); //o comando finish() retorna o fluxo para a tela anterior, mas não atualiza a tela ao retornar. Se quiser atualizar
        // a tela ao retornar é melhor usar a Intent mesmo.
    }
}